...
class MongoshNodeRepl {
    ...
    async initialize(serviceProvider) {
        ...
        repl.context.Date = Date;
        {
            ...
            if (((_e = globalCryptoDescriptor.value) === null || _e === void 0 ? void 0 : _e.subtle) ||
                ((_g = (_f = globalCryptoDescriptor.get) === null || _f === void 0 ? void 0 : _f.call(null)) === null || _g === void 0 ? void 0 : _g.subtle)) {
